 ...
 // 휴대폰 번호 정규식 
   ...
   $.ajax({
    ...
    $('form').on('submit',function(){
      ...
      if (($('#mem_pw').val() == ($('#mem_pw2').val())) && pwJ.test($('#mem_pw').val())) {
         ...
         inval_Arr[1] = false; alert('비밀번호를 확인하세요.');
       return false; 
      }
       // 이름 정규식
   ...
   $('#mem_id').blur(function() {
    ...
    $('#mem_pw').blur(function() { 
       ...
       console.log('false'); 
       $('#pw_check').text('4~12자의 숫자 , 문자로만 사용 가능합니다.'); $('#pw_check').css('color', 'red'); 
    }
     });
   //1~2 패스워드 일치 확인 
...
<body> 
   ...
   <input type="text" class="form-control" id="mem_id" name="mem_id" placeholder="ID">
    <div class="eheck_font" id="id_check">
   </div>
    </div> 
   <div class="form-group">
   ...
   <div class="form-group">
      ...
      <div class="eheck_font" id="email_check">
   </div> 
   </div>
    <div class="form-group">
