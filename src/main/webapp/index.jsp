    ...
    <div class="full-width back-image" style="width: 100%; height: 50%;" id="first">
        <div class="wrap">
            <div class="first-part">
                <h1><span style="color:white">Make Your Hobby!</span></h1>
            </div>
        </div>
    </div>
        ...
        <div class="set_size_section1">
            ...
            <div class="article_center2">
                <article class="section1_article">
                    <img alt="Basket" src="./imgs/cook.png" width="78" height="77">
                    <h3>COOK</h3>
                    <p>요리</p>
                    </article>
                <article class="section1_article">
                    <img alt="Laptop" src="./imgs/art.png" width="78" height="77">
                    <h3>ART</h3>
                    <p>미술</p>
                </article>
                <article class="section1_article">
                    <img alt="Locked" src="./imgs/music.png" width="78" height="77">
                    <h3>MUSIC</h3>
                    <p>음악</p>
                </article>
                <article class="section1_article">
                    <img alt="Locked" src="./imgs/sports.png" width="78" height="77">
                    <h3>SPORTS</h3>
                    <p>스포츠</p>
                </article>
                <article class="section1_article">
                    <img alt="Locked" src="./imgs/diy.png" width="78" height="77">
                    <h3>DIY</h3>
                    <p>DIY</p>
                </article>
            </div>
    ...
    <div class="full-width back-image3 full-page page" id="third">
        <div class="wrap">
            ...
            <div class="inner">
                ...
                <img src="./imgs/workplace-2303851_640.jpg" class="img-50 img-right">
    ...
    <div class="full-width back-image4 full-page page" id="fourth">
        <div class="wrap">
            ...
            <div class="inner customer">
                <h2>Contact Us</h2>
                <p>자신만의 취미 클래스를 등록하고 싶다면 MY HOB!에 문의 해주세요.</p>
